...
import demo.jaxrs.server.PasswordPolicyTO;
import demo.jaxrs.server.PolicyTO;
import demo.jaxrs.server.PolicyType;
import demo.jaxrs.server.SyncPolicyTO;
...
//        providers.add( new JacksonJaxbJsonProvider() );
        ...
        CustomerService service = JAXRSClientFactory.create("http://localhost:9001/customerservice/", CustomerService.class, providers);
